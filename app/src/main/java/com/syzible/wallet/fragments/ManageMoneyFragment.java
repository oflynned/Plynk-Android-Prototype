...
import com.syzible.wallet.ui.TransactionItemDecoration;
...
public class ManageMoneyFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.digital_card).setOnClickListener(v -> {
    ...
    private void getCardData() {
        RestClient.post(getActivity(), Endpoints.GET_DIGITAL_CARD_DATA, JSONUtils.getId(getActivity()), new BaseJsonHttpResponseHandler<JSONObject>() {
            @Override
